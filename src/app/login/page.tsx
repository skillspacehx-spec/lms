...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await login(formData.email, formData.password, redirect);
    } catch (err: any) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#7AC2F9] via-blue-500 to-indigo-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-start p-8 lg:p-12 text-white">
          ...
          <p className="text-lg lg:text-xl mb-8 text-white/90 leading-relaxed">
            Continue your education with personalized tutoring sessions,
            expert guidance, and flexible scheduling that works for you.
          </p>
          {/* <div className="flex items-center space-x-2">
            <div className="flex -space-x-2">
              ...
              <div className="w-8 h-8 bg-white/30 rounded-full border-2 border-white"></div>
              <div className="w-8 h-8 bg-white/30 rounded-full border-2 border-white"></div>
              <div className="w-8 h-8 bg-white/30 rounded-full border-2 border-white flex items-center justify-center text-sm">
                +2k
              </div>
            </div>
            <span className="text-white/90 ml-4">Trusted by over 2,000 students</span>
          </div> */}
        </div>
      </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              {/* <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-[#7AC2F9] focus:ring-[#7AC2F9] border-gray-300 rounded"
                />
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                ...
                <Link href="/register" className="font-medium text-[#7AC2F9] hover:text-[#5BA3E0]">
                  Create Account
                </Link>
              </span>
            </div>
